...
class HandGeneratorTests: XCTestCase {
    ...
    func testGenerateAllHands() throws {
        throw XCTSkip("This test is skipped because it takes too long to run (generates and tests all possible hand combinations)")
